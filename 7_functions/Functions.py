...
def even_odd_list(arr):
    ...
    for item in arr:
        if item % 2 == 0 and item > 0:
            ...
            add_odd = item
            odd.append(add_odd)
    print("чётный список=", even)
    print("нечётный список=", odd)
...
def spl(arr):
    ...
    for item in range(len(arr)):
        ...
        if not sum_100:
            print('No lists - sum > 100', sum_100)
        else:
...
def salary(age):
    if 0 <= age < 100:
        if 18 <= age < 27:
            ...
            print('За 12 лет Вы сумеете отложить 150000$')
            print('За 15 лет Вы сумеете отложить 100000$')
        elif 27 <= age < 42:
            print('За 4 лет Вы сумеете отложить 10000$')
            print('За 6 лет Вы сумеете отложить 20000$')
            print('За 8 лет Вы сумеете отложить 30000$')
            print('За 9 лет Вы сумеете отложить 150000$')
            print('За 12 лет Вы сумеете отложить 100000$')
        elif 42 <= age < 63:
            print('За 1 лет Вы сумеете отложить 10000$')
            print('За 1,5 лет Вы сумеете отложить 20000$')
            print('За 2 лет Вы сумеете отложить 30000$')
            print('За 3 лет Вы сумеете отложить 150000$')
            print('За 5 лет Вы сумеете отложить 100000$')
        elif 63 <= age < 100:
            print('Пора бы отдохнуть от работы')
        elif age < 18:
...
# 15) Написать функцию которая получив на вход стартовую ЗП Junior QA и количество лет стажа выведет в консоль прогресс роста ЗП по каждому году из введенного количества лет стажа.
